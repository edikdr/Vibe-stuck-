...
- **562 записи** вместо 393: 216 API, 230 библиотек, 65 MCP-серверов, 51 skill, 68 категорий, 7 разделов верхнего уровня;
- **73 записи с ценами** и 398 записей, доступных бесплатно или с открытым кодом;
...
Каталог на 562 записи прокручивается далеко, поэтому в него добавлен `ScrollTopHook` — обёртка над любым скроллом:
